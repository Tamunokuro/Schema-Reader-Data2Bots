...
class JSONReader:
    ...
    def process_json(self, data: Dict[str, Any]) -> JSONSchema:
        """
        No data type was given for an attribute that it's value is
        a dictionary so the type: OBJECT was used.
        """
        ...
        for key, value in message_attr.items():
            ...
            elif isinstance(value, dict) or all(
    ...
    def process_json_files(self) -> None:
        ...
        for file_name in os.listdir(self.path):
            if file_name.endswith(".json"):
                ...
                print(
                    f"{file_path} has been processed and written to {schema_output_path}"
                )
